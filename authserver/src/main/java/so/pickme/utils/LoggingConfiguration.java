...
public class LoggingConfiguration {
	...
	private static final String POINTCUT_EXECUTION_REPOSITORY = "execution(public * so.pickme.service..*(..))";
	...
	protected static final Logger logger4J = Logger.getLogger("aop");
